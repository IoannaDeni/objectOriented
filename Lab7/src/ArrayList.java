...
{
	//Note for anyone looking: this isn't a good way to do Assignment 4. Please do not use this
	//as an example for how to make a linked list. Also, I got lazy and didn't make any inline
	//comments. Don't be like me.
	
	// Java can't use generics for array
	// but we want this to logically be T[] arr
	// we use casting to maintiain types, but have to be careful to only use T elements!
	private Object[] arr; 
	...
	*
	* @param elt the element to be added to the list
	* @param index the location to add the T
	*/
