...
public class ExtraCreditRace extends WindowController
{
    ...
    public void begin () 
    {
        ...
        String beginning = "Racing Mohos";
        text = new Text (beginning, LINE_LENGHT/2 - MARGIN*3, topS + MARGIN + getHeight, canvas);
    ...
    public void onMouseClick (Location point) {
        ...
        if (x==1) {
            ...
            WinningMascot sphinxM = new WinningMascot (left, topS, sphinx, canvas, MARGIN);

            int winnerL = lionM.winner();
            int winnerP = pegasusM.winner();
            int winnerG = griffinM.winner();
            int winnerS = sphinxM.winner();

            //This is for the winner
            if (winnerS<winnerL && winnerS<winnerP && winnerS<winnerG){
                //change the text to see the winner
                text.removeFromCanvas();
                text = new Text ("The winner is the Sphinx!", LINE_LENGHT/2 - MARGIN*6, topS + MARGIN + getHeight, canvas);
                Font font = new Font("Jokerman", Font.PLAIN, 35);
                text.setFont(font);
                Color fontColor = new Color (180, 0, 255);
                text.setColor(fontColor);
            ...
            else if (winnerL<winnerP && winnerL<winnerG && winnerL<winnerS){
                //change the text to see the winner
                text.removeFromCanvas();
                text = new Text ("The winner is the Lion!", LINE_LENGHT/2 - MARGIN*6, topS + MARGIN + getHeight, canvas);
                Font font = new Font("Jokerman", Font.PLAIN, 35);
                text.setFont(font);
                Color fontColor = new Color (180, 0, 255);
                text.setColor(fontColor);
            ...
            else if (winnerP<winnerL && winnerP<winnerG && winnerP<winnerS){
                //change the text to see the winner
                text.removeFromCanvas();
                text = new Text ("The winner is the Pegasus!", LINE_LENGHT/2 - MARGIN*6, topS + MARGIN + getHeight, canvas);
                Font font = new Font("Jokerman", Font.PLAIN, 35);
                text.setFont(font);
                Color fontColor = new Color (180, 0, 255);
                text.setColor(fontColor);
            ...
            else if (winnerG<winnerL && winnerG<winnerP && winnerG<winnerS){
                //change the text to see the winner
                text.removeFromCanvas();
                text = new Text ("The winner is the Griffin!", LINE_LENGHT/2 - MARGIN*6, topS + MARGIN + getHeight, canvas);
                Font font = new Font("Jokerman", Font.PLAIN, 35);
                text.setFont(font);
                Color fontColor = new Color (180, 0, 255);
                text.setColor(fontColor);
