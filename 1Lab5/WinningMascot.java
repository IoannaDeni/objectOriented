...
public class WinningMascot extends ActiveObject
{
     ...
     */
    public WinningMascot(double left, double top, Picture picture, DrawingCanvas canvas, int offscreen)
    {
    ...
    public void run() {
        ...
        while (leftMargin > offScreen) {
            ...
            RandomIntGenerator speedGen = new RandomIntGenerator (6, 9);
            int xSpeed = speedGen.nextValue();
