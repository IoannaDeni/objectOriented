 ...
 * @version 10/13/16
 * 
 * @updated by Ioanna Deni at 10/5/2017
 * added the vertical check by just copying the code for horizontal and switching row with col 
 */
	...
	private boolean checkVerticalWin(){
		//initialize int for counting connected values
				...
				for(int col = 0 ; col<BOARD_SIZE; col++){
					//First raw can't be compared, so set it as comparison
